...
function AimaFormInner() {
  ...
  useEffect(() => {
    if (!token) {
      setErro('Token em falta. Verifique o link recebido por email.');
      setLoading(false);
      return;
    }
        ...
        <div className="px-8 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-[#FAF8F4] border border-[#D4C5A9] p-4 text-[11px] text-gray-500 leading-relaxed">
              ...
              <a href="/tratamento-dados" className="text-[#C4A484] underline" target="_blank" rel="noreferrer">Política de Tratamento de Dados</a>.
            </div>
      ...
      <div className="flex items-center gap-3 px-5 py-4 cursor-pointer select-none" onClick={onToggle}>
        ...
        {onRemove && (
          <button type="button" onClick={(e) => { e.stopPropagation(); onRemove(); }}
            className="flex-shrink-0 text-gray-300 hover:text-red-400 transition-colors cursor-pointer p-1" title="Remover hóspede">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {isOpen && (
        <div className="px-5 pb-6 border-t border-gray-100 pt-5 space-y-7">
          ...
          <section>
            ...
            <div className="mt-4">
              <label className="text-[10px] uppercase tracking-widest font-semibold text-gray-400 block mb-2">Fotografia do Documento</label>
...
/* ── Root export com Suspense (obrigatório para useSearchParams em static export) ── */
